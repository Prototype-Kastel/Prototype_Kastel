      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#rooms" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="rooms">
              ...
              <div class="collapse" id="rooms">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="../Pages/Rooms/Room/Room.html" class="nav-link">
                      <span class="sidenav-mini-icon">  </span>
                      <span class="sidenav-normal"> Room </span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../Rooms/RoomType/RoomType.html" class="nav-link">
                      <span class="sidenav-mini-icon">  </span>
                      <span class="sidenav-normal"> Room Type </span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../Rooms/RoomPrice/RoomPrice.html" class="nav-link">
                      <span class="sidenav-mini-icon">  </span>
                      <span class="sidenav-normal"> Room Price </span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../Rooms/Service/Service.html" class="nav-link">
                      <span class="sidenav-mini-icon">  </span>
            ...
            <li class="nav-item">
              <a class="nav-link" href="#service" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="service">
                <i class="ni ni-single-copy-04 text-pink"></i>
                <span class="nav-link-text">Room Service</span>
              </a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="../../transactionNonComercial.html">
                <i class="ni ni-money-coins text-red"></i>
                <span class="nav-link-text">Transaction non Comercial</span>
              </a>
            </li>
            <li class="nav-item">
